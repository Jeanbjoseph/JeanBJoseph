...
<p align="center">
  <strong>AI Solutions Architect &nbsp;·&nbsp; LLMs & Agents for Industrial Applications &nbsp;·&nbsp; PhD</strong>
</p>
...
**AI / LLMs**
`Azure OpenAI` · `Azure Blob Storage` · `LangChain` · `LangGraph` · `RAG` · `Vector databases`
...
I'm on a 12-month journey to deepen my AI engineering skills. You'll see this reflected in the repos I publish:

- LLM orchestration with LangGraph
- Multi-agent systems with CrewAI / Agno
- LLMOps: tracing with Langfuse, evaluation with RAGAS
- Production guardrails and observability

### Featured projects

> 📌 *Pinned repositories below show my best work. Each one focuses on a real problem in the industrial / geosciences space.*
